...
Uso:
    ...
    python main.py --demo                Analisa um programa embutido
    python main.py <arquivo> --acoes     Também imprime o traço shift/reduce
    python main.py <arquivo> --tokens    Também imprime a tabela de tokens
