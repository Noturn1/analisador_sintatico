...
DECISOES.md #5):
  1. desempilha estados até um estado s com GOTO sobre um não-terminal de
     recuperação A (comando, bloco, expressao, funcao — nessa prioridade);
...
diretamente a recuperação (também ver DECISOES.md #9).

Saída (ver DECISOES.md #4): aceita/rejeita, lista de erros sintáticos, o traço
de ações shift/reduce e a árvore sintática.
"""
